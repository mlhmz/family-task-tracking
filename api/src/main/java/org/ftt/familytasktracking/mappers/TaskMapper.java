...
public interface TaskMapper {
    ...
    /**
     * Maps a {@link TaskResponseDto}-Entity to a {@link Task}.
     * <p>
     * <b>IMPORTANT:</b> Only the uuid of the assignee will be mapped into the assignee object.
     *
     * @param taskResponseDto {@link TaskResponseDto} to map
     * @return Mapped {@link Task}
     */
    @InheritInverseConfiguration
    @Mapping(target = "household", ignore = true)
    Task mapTaskDtoToTask(TaskResponseDto taskResponseDto);
}
